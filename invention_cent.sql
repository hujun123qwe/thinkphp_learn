...
--
-- Host: localhost
-- Generation Time: 2016-05-29 21:25:41
...
INSERT INTO `ahut_user` (`user_id`, `student_id`, `user_name`, `email`, `password`, `address`, `add_time`, `last_login`, `last_ip`) VALUES
(1, 0, '', '', 'd41d8cd98f00b204e9800998ecf8427e', '安徽工业大学', 0, 0, ''),
(2, 0, '', '', 'd41d8cd98f00b204e9800998ecf8427e', '安徽工业大学', 0, 0, '');
...
--
-- Indexes for table `oc_admin_module`
--
ALTER TABLE `oc_admin_module`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `oc_admin_module`
--
ALTER TABLE `oc_admin_module`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',AUTO_INCREMENT=4;
