...
--
-- Host: localhost
-- Generation Time: 2016-06-03 14:58:43
...
CREATE TABLE IF NOT EXISTS `ahut_application` (
  ...
  `inspector _id` smallint(6) unsigned NOT NULL DEFAULT '0'
...
INSERT INTO `ahut_application` (`apply_id`, `item_name`, `item_id`, `item_status`, `user_id`, `apply_time`, `apply_info`, `verify_time`, `is_verify`, `inspector _id`) VALUES
(1, 'fewewdfew', 1, 0, 23, 123, '123fewfewfew', 12312, 0, 0),
(2, '大学生诚信项目是ixnajisdie', 0, 0, 0, 123, 'HFE', 0, 0, 0),
(3, '大学生诚信项目是ixnajisdie', 0, 0, 0, 123, 'HFE', 0, 0, 0),
(4, '等级的英文_等级翻译_等级英语怎么说_海词词典', 0, 0, 0, 129084213, '海词词典', 0, 0, 0),
(5, 'gtrgtrgtr', 0, 0, 23, 123, '123', 12312, 0, 0),
(6, 'ew', 0, 0, 0, 12, 'we', 0, 0, 0),
(7, 'ew', 0, 0, 0, 12, 'we', 0, 0, 0),
...
(19, 129084213, '胡军', 0, '未定义', '未定义', 'hujun123qwe@163.com', '1555150525', '03e15259561469276b1ef6b14cb38af6', '安徽工业大学', 1464931258, 1464931258, '127.0.0.1');
...
ALTER TABLE `ahut_credits`
  ADD PRIMARY KEY (`credits_id`), ADD UNIQUE KEY `credits_id` (`credits_id`);
...
--
ALTER TABLE `ahut_application`
  MODIFY `apply_id` int(6) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `ahut_credits`
--
ALTER TABLE `ahut_credits`
  MODIFY `credits_id` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
