            ...
            <ul class="boxed-group-inner mini-repo-list">
                <li class="public source">
                    <table class="capped-list">
                        <thead><tr><th>#</th><th>编号</th><th>姓名名</th><th>学号</th><th>学院</th><th>班级</th><th>手机号码</th><th>注册时间</th><th>操作</th></tr></thead>
                        <tbody>
                        <?php if(is_array($lists)): $k = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td><?php echo ($vo["iclass"]); ?></td>
                                <td><?php echo ($vo["phone"]); ?></td>
                                <td><?php echo (date("y-m-d",$vo["add_time"])); ?></td>
                                <td><a href="edit_student_pro?user_id_student=<?php echo ($vo["user_id"]); ?>">编辑</a>&nbsp;
                                    <a href="delete_student?user_id=<?php echo ($vo["user_id"]); ?>">删除</a>
                                </td>
