...
<body class="logged-out env-production windows signup">
            ...
            <div id="js-pjax-container" data-pjax-container>
                <div class="setup-wrapper">
                    <div class="setup-header setup-org">
                        ...
                        <p class="lead">
                            You’ve taken your first step into a larger world, <strong><?php echo ($user_name); ?></strong>.
                        </p>
                    ...
                    <div class="setup-main">
                        ...
                        <form accept-charset="UTF-8" action="/join/plan" autocomplete="off" class="setup-form js-braintree-encrypt" data-braintree-key="" data-form-nonce="e45f762bcdf7d75ad390d1c0c998de70ec8d0c4d" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="H+lGRvoGlhLZscJ0Ba09UF/PGtAj9Hul0PN03GrRxGv5KluHC29NTLm022D0uOl+LoyQOb12/J+6m7DFM/TPYw==" /></div>
                            ...
                            <div class="currency-container js-details-container">
                                ...
                                <label class="plan-choice plan-choice-free js-plan-choice-label open">
                                    <input type="radio" class="plan-choice-radio js-plan-choice" name="plan" value="2" checked>
                                    学科竞赛
                                </label>
                                <label class="plan-choice plan-choice-free js-plan-choice-label open">
                                    <input type="radio" class="plan-choice-radio js-plan-choice" name="plan" value="3" checked>
                                    “三创”教育课程体系
                                </label>
                                <label class="plan-choice plan-choice-free js-plan-choice-label open">
                                    <input type="radio" class="plan-choice-radio js-plan-choice" name="plan" value="4" checked>
                                    论文发表学分认定
                                </label>
                                <label class="plan-choice plan-choice-free js-plan-choice-label open">
                                    <input type="radio" class="plan-choice-radio js-plan-choice" name="plan" value="5" checked>
                                    SRTP活动
                                </label>
                                <label class="plan-choice plan-choice-free js-plan-choice-label open">
                                    <input type="radio" class="plan-choice-radio js-plan-choice" name="plan" value="6" checked>
                                    专利成果
                                </label>
                                <label class="plan-choice plan-choice-free js-plan-choice-label open">
                                    <input type="radio" class="plan-choice-radio js-plan-choice" name="plan" value="7" checked>
                                    其他科研、学术等创新活动
                                </label>
        ...
        <div class="container site-footer-container">
            <div class="site-footer" role="contentinfo">
                <a href="" aria-label="Homepage" class="site-footer-mark" title="GitHub">
